...
const CheckoutPage = () => {
  ...
  if (orderPlaced) {
    const WHATSAPP_LINK = `https://wa.me/923262188824?text=Hi%20Sandy!%20I%20just%20placed%20order%20${orderNumber}.%20Can%20you%20help%20me%20track%20it%3F`;

    const deliverySteps = [
      { icon: CheckCircle2, label: "Order Confirmed", subtitle: "We've received your order", active: true },
      { icon: ChefHat, label: "Preparing", subtitle: "Your food is being made with care", active: true },
      { icon: PackageCheck, label: "Ready for Rider", subtitle: "Packed & handed to delivery", active: false },
      { icon: Bike, label: "On the Way", subtitle: "Rider is heading to your location", active: false },
      { icon: UtensilsCrossed, label: "Delivered!", subtitle: "Enjoy your meal 🎉", active: false },
    ];

    const pickupSteps = [
      { icon: CheckCircle2, label: "Order Confirmed", subtitle: "We've received your order", active: true },
      { icon: ChefHat, label: "Preparing", subtitle: "Your food is being made with care", active: true },
      { icon: PackageCheck, label: "Ready for Pickup!", subtitle: "Head to the counter & collect", active: false },
    ];
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        >
          ...
          {/* Order details */}
          <div className="mt-5 rounded-2xl border border-border bg-card p-5 w-full">
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      {!isLast && (
                        <div
                          className={`w-0.5 ${
                            step.active && nextActive ? "bg-primary" : "bg-border"
                          }`}
                          style={{ height: "24px" }}
                        />
                      )}
                    ...
                    {/* Label */}
                    <div className="pb-4 text-left -mt-0.5">
                      <p
                        className={`text-sm font-semibold ${
                          step.active ? "text-card-foreground" : "text-muted-foreground/50"
                        }`}
                      >
                        {step.label}
                      </p>
                      <p
                        className={`text-xs ${
                          step.active ? "text-muted-foreground" : "text-muted-foreground/35"
                        }`}
                      >
                        {step.subtitle}
                      </p>
